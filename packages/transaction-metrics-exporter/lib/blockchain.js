            ...
            switch (_a.label) {
                ...
                case 2:
                    ...
                    listeningWatcher = task_1.conditionWatcher({
                        ...
                        initialDelayMS: 5000,
                        pollCondition: function () { return __awaiter(_this, void 0, void 0, function () { return __generator(this, function (_a) {
                            switch (_a.label) {
                                case 0: return [4 /*yield*/, kit.isListening()];
                            ...
                            return __generator(this, function (_d) {
                                switch (_d.label) {
                                    ...
                                    case 2:
                                        ...
                                        blockTime = block.timestamp - previousBlock.timestamp;
